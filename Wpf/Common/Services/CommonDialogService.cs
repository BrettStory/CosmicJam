namespace Macabre2D.Wpf.Common.Services {
    ...
    using Macabre2D.Wpf.Common.Dialogs;
    using Macabre2D.Wpf.Common.Extensions;
    ...
    public interface ICommonDialogService {
        ...
        bool ShowSaveFileBrowser(string filter, out string path, string initialDirectory = null);
    ...
    public class CommonDialogService : ICommonDialogService {
        ...
        public bool ShowSaveFileBrowser(string filter, out string path, string initialDirectory = null) {
